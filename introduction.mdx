---
title: Introduction
description: Float gives AI agents their own treasury. Load USDC once, let your agents pay for everything automatically.
---

## What is Float?

Float is a Solana-native treasury for AI agents. You load USDC once — Float gives each of your agents a wallet, spending limits, and x402 payment rails. When an agent needs to call a paid API, it pays automatically, without stopping to ask.
