...
Float maintains a registry of x402-compatible services your agents can discover at runtime using the [`find_service`](/mcp/tools#find_service) MCP tool. The registry includes:
